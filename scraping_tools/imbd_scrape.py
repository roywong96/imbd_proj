...
def get_movie_links(pages, start=1):
    ...
    for i in range(pages):
        url = f"https://www.imdb.com/search/title/?title_type=feature&release_date=2000-01-01,2020-05-01&countries=us&languages=en&view=simple&count=100&start={start}&ref_=adv_nxt"
